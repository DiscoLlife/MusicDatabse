...
<?php include("topbit.php") ?>
    ...
    <nav class="navbar navbar-default" style= "background-color: var(--main-nav-color); color: #999">
      <div class="container-fluid">
        <ul class="nav navbar-nav" >
          ...
          <li class="active"><a style= "background: var(--main-decor-color); color: var(--main-fonts-color)" href="#">Contact</a></li>
  ...
  <main>
    <h2>Contact</h2>
    <p>Search else where, I aint gonna tell you a damm thing</p>
  </main>
